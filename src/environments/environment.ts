export const environment = {
    ...
    env: {
        ...
        backend: {
            ...
            get_popular_keywords_service: "visuals/getKeywordsCount",
            get_tool_suggestion_data: "authuseractions/getToolSuggestionDataForm",
            get_digital_tool: "authuseractions/getDigitalTool",
            update_digital_tool: "authuseractions/updateDigitalTool",
            get_suggested_digital_tools: "authuseractions/getSuggestedDigitalTools",
            delete_suggested_digital_tool: "authuseractions/deleteSuggestedDigitalTool",
            delete_stored_digital_tool: "authuseractions/deleteStoredDigitalTool",
            suggest_digital_tool: "authuseractions/suggestDigitalTool",
            get_suggested_tool: "authuseractions/getSuggestedTool",
            update_digital_tool_suggestion: "authuseractions/updateDigitalToolSuggestion",
            get_all_suggested_digital_tools: "authuseractions/getAllSuggestedDigitalTools",
            commit_suggested_tool: "authuseractions/commitSuggestedDigitalTool",
            ...
            digital_tool_management_get_tools:'authuseractions/getToolsSimpleView',
            analytics_get_tool_relation_graph: 'analytics/getToolRelationGraph',
            get_user_background_options: "user-background/getUserBackgroundOptions",
            register_user_background_selection: "user-background/registerUserBackgroundSelection",
            user_client_is_known : "user-background/userClientIsKnown",
            dt_url_click:"analytics/dtUrlClick",
        ...
        ga: {
            ...
            header: "(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-WQW8KVP');",
            body: "<iframe src=\"https://www.googletagmanager.com/ns.html?id=GTM-WQW8KVP\" height=\"0\" width=\"0\" style=\"display:none;visibility:hidden\"></iframe>"
        },
        user_landing_page: {
            views: [
        ...
        landing_page: {
            ...
            text: {
                ...
                description: "The DESIRA knowledge base of potential Digital Game Changers in Rural Areas",
