...
@Component({
  ...
  export class CookieBanner {
      ...
      public shouldProceedIsShowingTheBanner(){
        if(localStorage.getItem(UserBackgroundModal.userHasFilledBackgroundKey) === "false" && localStorage.getItem(UserBackgroundModal.userBackgroundModalKey) !== null ) {
           return false;
        }
        return true;
      }
      ...
      showBanner(){
        //console.log("Show banner ->" + (this.initialized && !this.usingCookies() && this.isModalClosed && !this.anotherModalIsOpen()))
        if(localStorage.getItem(UserBackgroundModal.userBackgroundModalKey) === "true"){
          return false;
        }
        return this.initialized && !this.usingCookies() && this.isModalClosed && !this.anotherModalIsOpen();
      }
